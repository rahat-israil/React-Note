...
## **React Hooks এবং `useState`**

### **React Hooks কী?**

React Hooks হলো এমন কিছু বিশেষ ফাংশন যা **Functional Components**-এ React-এর **state** এবং **lifecycle** feature ব্যবহার করার সুযোগ করে দেয়।

React 16.8 ভার্সনে এটি যুক্ত করা হয়। Hooks এর মাধ্যমে আমরা কোনো ক্লাস লিখা ছাড়াই React এর শক্তিশালী ফিচারগুলো ব্যবহার করতে পারি।

### **`useState` কী?**

`useState` হলো React-এর একটি Hook, যা একটি Functional Component-এ **state** যোগ করার সুযোগ করে দেয়।

State হলো এমন একটি মান যা Component-এর মধ্যে **পরিবর্তনশীল ডেটা** সংরক্ষণ করে।

`useState` দুইটি জিনিস ফেরত দেয়:

1. বর্তমান state-এর মান।
2. একটি ফাংশন যা state আপডেট করতে সাহায্য করে।

---

### **`useState` এর কাজ করার ধরণ**

1. **`useState` ইমপোর্ট করা:**
...
2. **State ঘোষণা করা:**
    ...
    - **state:** বর্তমান মান।
    - **setState:** state আপডেট করার জন্য ফাংশন।
    - **initialValue:** state-এর প্রাথমিক মান।


### **উদাহরণ: Counter তৈরি `useState` দিয়ে**

```jsx
import React, { useState } from "react";

function CounterApp() {
  const [count, setCount] = useState(0); // state ঘোষণা করা হলো

  const increment = () => {
    setCount(count + 1); // state আপডেট
  };
...
- **`count`** প্রাথমিক মান হিসেবে `0` দিয়ে শুরু হয়েছে।
- **`setCount(count + 1)`** state এর মান ১ করে বাড়াবে।
- যখন state পরিবর্তিত হবে, React Component-টি পুনরায় রেন্ডার করবে এবং আপডেট হওয়া মান দেখাবে।

## **React-এর অন্যান্য Hooks সংক্ষেপে**

1. **`useState`:**
    - Local Component state ম্যানেজ করতে ব্যবহৃত হয়।
    - উদাহরণ: Counter, ফর্মের ইনপুট মান, টগল ইত্যাদি।
2. **`useEffect`:**
    - Side effects (ডেটা ফেচিং, ডম পরিবর্তন, সাবস্ক্রিপশন) পরিচালনা করতে ব্যবহৃত হয়।
    - উদাহরণ:
        
        ```jsx
        useEffect(() => {
          console.log("Component রেন্ডার বা আপডেট হয়েছে!");
        });
        ```
        
3. **`useContext`:**
    - Props পাস না করেই Context value অ্যাক্সেস করতে ব্যবহৃত হয়।
4. **`useReducer`:**
    - জটিল state লজিক পরিচালনার জন্য।
5. **`useRef`:**
    - DOM এলিমেন্ট অথবা কোনো মান সংরক্ষণ করতে ব্যবহৃত হয় যা রেন্ডার হয় না।


## **Understand the concept of React `useEffect`**

**`useEffect` কী?**

React-এ `useEffect` একটি **Hook**, যা আপনার কোডে **side effects** পরিচালনা করতে ব্যবহৃত হয়।

**Side effects** মানে এমন কাজ যা React এর রেন্ডারিং-এর বাইরের:

- API থেকে ডেটা ফেচ করা
- DOM আপডেট করা
- Timer সেট করা
- Event Listener যোগ করা বা অপসারণ করা ইত্যাদি।
